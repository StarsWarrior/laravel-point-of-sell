                    ...
                    <form action="{{ url('/transcation') }}" method="get">
                        <div class="row">
                            ...
                            <div class="col-sm-3"><button type="submit"
                                    class="btn btn-primary btn-sm float-right btn-block">Cart Product</button></div>
                        </div>
                    </form>
                </div>
                <div class="card-body">
                        ...
                        <div style="width: 16.66%;border:1px solid rgb(243, 243, 243)" class="mb-4">
                            <div class="productCard">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-center">TK. {{ number_format($product->price,2,',','.') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{Str::words($item['name'],3)}} <br>TK.
                    ...
                    <table class="table table-sm table-borderless">
                        <tr>
                            ...
                            <th width="40%" class="text-right">TK.
                        ...
                        <tr>
                            ...
                            <th class="text-right">TK.
                                {{ number_format($data_total['tax'],2,',','.') }}</th>
                        </tr>
                        <tr>
                            <th>Total</th>
                            <th class="text-right font-weight-bold">TK.
        ...
        <!-- Sorry campur2 bahasa indonesia sama inggris krn kebiasaan make b.inggris eh ternyata buat aplikasi buat indonesia jadi gini deh  -->
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h1 class="font-weight-bold mb-5">TK. {{ number_format($data_total['total'],2,',','.') }}</h1>
                    ...
                    <h3 class="font-weight-bold text-primary">Change:</h3>
